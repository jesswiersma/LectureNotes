...
/*
    What is an API?
        ...
        - APIs are an access point to the server - what we call an "endpoint"; we change endpoints to get back specific information
        - Ex:                  *endpoint
...
Parts of a fetch()
    ...
    To clarify, the .json() method returns the converted JS object as a promise so we need to chain another .then to handle that promise.   
    ...
    4. We are JSON-ify the result, the .json() method will return another promise
